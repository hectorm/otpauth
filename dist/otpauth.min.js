...
var e=t.token,r=t.secret,n=t.algorithm,i=t.period,o=void 0===i?M:i,a=t.timestamp,s=void 0===a?Date.now():a,u=t.window;return L.validate({token:e,secret:r,algorithm:n,counter:Math.floor(s/1e3/o),window:u})}}]),t}(),E="5.0.7";e.default={HOTP:L,TOTP:z,URI:B,Secret:v,Utils:i.b,version:E}}])}));
