...
function o(t){return 1099511627776*(t-Math.floor(t))&255}for(;r<80;n++){for(e=!0,t=2;t*t<=n;t++)if(n%t==0){e=!1;break}e&&(r<8&&(this._init[2*r]=i(Math.pow(n,.5)),this._init[2*r+1]=o(Math.pow(n,.5))<<24|this._initr[r]),this._key[2*r]=i(Math.pow(n,1/3)),this._key[2*r+1]=o(Math.pow(n,1/3))<<24|this._keyr[r],r++)}},_block:function(t){var e,r,n,i,o=this._h,a=this._key,s=o[0],h=o[1],u=o[2],c=o[3],f=o[4],l=o[5],d=o[6],p=o[7],g=o[8],b=o[9],y=o[10],v=o[11],_=o[12],m=o[13],w=o[14],U=o[15];if("undefined"!=typeof Uint32Array){i=Array(160);for(var k=0;k<32;k++)i[k]=t[k]}else i=t;var A=s,S=h,I=u,T=c,B=f,x=l,O=d,C=p,M=g,P=b,L=y,R=v,j=_,z=m,H=w,D=U;for(e=0;e<80;e++){if(e<16)r=i[2*e],n=i[2*e+1];else{var E=i[2*(e-15)],V=i[2*(e-15)+1],q=(V<<31|E>>>1)^(V<<24|E>>>8)^E>>>7,N=(E<<31|V>>>1)^(E<<24|V>>>8)^(E<<25|V>>>7),$=i[2*(e-2)],G=i[2*(e-2)+1],Y=(G<<13|$>>>19)^($<<3|G>>>29)^$>>>6,Z=($<<13|G>>>19)^(G<<3|$>>>29)^($<<26|G>>>6),F=i[2*(e-7)],J=i[2*(e-7)+1],K=i[2*(e-16)],Q=i[2*(e-16)+1];r=q+F+((n=N+J)>>>0<N>>>0?1:0),
r+=Y+((n+=Z)>>>0<Z>>>0?1:0),r+=K+((n+=Q)>>>0<Q>>>0?1:0)}i[2*e]=r|=0,i[2*e+1]=n|=0;var W=M&L^~M&j,X=P&R^~P&z,tt=A&I^A&B^I&B,et=S&T^S&x^T&x,rt=(S<<4|A>>>28)^(A<<30|S>>>2)^(A<<25|S>>>7),nt=(A<<4|S>>>28)^(S<<30|A>>>2)^(S<<25|A>>>7),it=(P<<18|M>>>14)^(P<<14|M>>>18)^(M<<23|P>>>9),ot=(M<<18|P>>>14)^(M<<14|P>>>18)^(P<<23|M>>>9),at=a[2*e],st=a[2*e+1],ht=D+ot,ut=H+it+(ht>>>0<D>>>0?1:0);ut+=W+((ht+=X)>>>0<X>>>0?1:0),ut+=at+((ht+=st)>>>0<st>>>0?1:0);var ct=nt+et;H=j,D=z,j=L,z=R,L=M,R=P,M=O+(ut+=r+((ht=ht+n|0)>>>0<n>>>0?1:0))+((P=C+ht|0)>>>0<C>>>0?1:0)|0,O=B,C=x,B=I,x=T,I=A,T=S,A=ut+(rt+tt+(ct>>>0<nt>>>0?1:0))+((S=ht+ct|0)>>>0<ht>>>0?1:0)|0}h=o[1]=h+S|0,o[0]=s+A+(h>>>0<S>>>0?1:0)|0,c=o[3]=c+T|0,o[2]=u+I+(c>>>0<T>>>0?1:0)|0,l=o[5]=l+x|0,o[4]=f+B+(l>>>0<x>>>0?1:0)|0,p=o[7]=p+C|0,o[6]=d+O+(p>>>0<C>>>0?1:0)|0,b=o[9]=b+P|0,o[8]=g+M+(b>>>0<P>>>0?1:0)|0,v=o[11]=v+R|0,o[10]=y+L+(v>>>0<R>>>0?1:0)|0,m=o[13]=m+z|0,o[12]=_+j+(m>>>0<z>>>0?1:0)|0,U=o[15]=U+D|0,o[14]=w+H+(U>>>0<D>>>0?1:0)|0}},o.misc.hmac=function(t,e){
...
;var r,n=e[1].toLowerCase(),o=e[2].split(/:(.+)/,2).map(decodeURIComponent),a=e[3].split("&").reduce(function(t,e){var r=e.split(/=(.+)/,2).map(decodeURIComponent),n=r[0].toLowerCase(),i=r[1],o=t;return o[n]=i,o},{}),s={};if("hotp"===n){if(r=T,void 0===a.counter||!m.test(a.counter))throw new TypeError("Missing or invalid 'counter' parameter");s.counter=parseInt(a.counter,10)}else{if("totp"!==n)throw new TypeError("Unknown OTP type");if(r=B,void 0!==a.period){if(!w.test(a.period))throw new TypeError("Invalid 'period' parameter");s.period=parseInt(a.period,10)}}if(2===o.length)if(s.label=o[1],void 0===a.issuer)s.issuer=o[0];else{if(a.issuer!==o[0])throw new TypeError("Invalid 'issuer' parameter");s.issuer=a.issuer}else s.label=o[0],void 0!==a.issuer&&(s.issuer=a.issuer);if(void 0===a.secret||!v.test(a.secret))throw new TypeError("Missing or invalid 'secret' parameter");if(s.secret=new g({buffer:i.b.b32.encode(a.secret)}),void 0!==a.algorithm){
if(!_.test(a.algorithm))throw new TypeError("Invalid 'algorithm' parameter");s.algorithm=a.algorithm}if(void 0!==a.digits){if(!w.test(a.digits))throw new TypeError("Invalid 'digits' parameter");s.digits=parseInt(a.digits,10)}return new r(s)}},{key:"stringify",value:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},r=e.legacyIssuer,n=void 0===r||r,i=t instanceof T,o=t instanceof B;if(!i&&!o)throw new TypeError("Invalid 'HOTP/TOTP' object");var a="otpauth://";return a+="".concat(o?"totp":"hotp","/"),t.issuer.length>0?(n&&(a+="".concat(encodeURIComponent(t.issuer),":")),a+="".concat(encodeURIComponent(t.label),"?"),a+="issuer=".concat(encodeURIComponent(t.issuer),"&")):a+="".concat(encodeURIComponent(t.label),"?"),a+="secret=".concat(encodeURIComponent(t.secret.b32))+"&algorithm=".concat(encodeURIComponent(t.algorithm))+"&digits=".concat(encodeURIComponent(t.digits)),a+=o?"&period=".concat(encodeURIComponent(t.period)):"&counter=".concat(encodeURIComponent(t.counter))}}],
(r=null)&&b(e.prototype,r),n&&b(e,n),t}();function k(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function A(t,e){for(var r=0;r<e.length;r++){var n=e[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}function S(t,e,r){return e&&A(t.prototype,e),r&&A(t,r),t}var I={issuer:"",label:"OTPAuth",algorithm:"SHA1",digits:6,counter:0,period:30,window:1},T=function(){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},r=e.issuer,n=void 0===r?I.issuer:r,i=e.label,o=void 0===i?I.label:i,a=e.secret,s=void 0===a?new g:a,h=e.algorithm,u=void 0===h?I.algorithm:h,c=e.digits,f=void 0===c?I.digits:c,l=e.counter,d=void 0===l?I.counter:l;k(this,t),this.issuer=n,this.label=o,this.secret="string"==typeof s?g.fromB32(s):s,this.algorithm=u,this.digits=f,this.counter=d}return S(t,[{key:"generate",value:function(){
var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},r=e.counter,n=void 0===r?this.counter++:r;return t.generate({secret:this.secret,algorithm:this.algorithm,digits:this.digits,counter:n})}},{key:"validate",value:function(e){var r=e.token,n=e.counter,o=void 0===n?this.counter:n,a=e.window;return t.validate({token:i.b.pad(r,this.digits),secret:this.secret,algorithm:this.algorithm,counter:o,window:a})}},{key:"toString",value:function(){return U.stringify(this)}}],[{key:"generate",value:function(t){var e=t.secret,r=t.algorithm,n=void 0===r?I.algorithm:r,o=t.digits,a=void 0===o?I.digits:o,h=t.counter,u=void 0===h?I.counter:h,c=new Uint8Array(s.hmacDigest(n,e.buffer,i.b.uint.encode(u))),f=15&c[c.byteLength-1],l=((127&c[f])<<24|(255&c[f+1])<<16|(255&c[f+2])<<8|255&c[f+3])%Math.pow(10,a);return i.b.pad(l,a)}},{key:"validate",value:function(e){for(var r=e.token,n=e.secret,i=e.algorithm,o=e.counter,a=void 0===o?I.counter:o,s=e.window,h=void 0===s?I.window:s,u=a-h;u<=a+h;++u){if(r===t.generate({secret:n,
algorithm:i,digits:r.length,counter:u}))return u-a}return null}}]),t}(),B=function(){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},r=e.issuer,n=void 0===r?I.issuer:r,i=e.label,o=void 0===i?I.label:i,a=e.secret,s=void 0===a?new g:a,h=e.algorithm,u=void 0===h?I.algorithm:h,c=e.digits,f=void 0===c?I.digits:c,l=e.period,d=void 0===l?I.period:l;k(this,t),this.issuer=n,this.label=o,this.secret="string"==typeof s?g.fromB32(s):s,this.algorithm=u,this.digits=f,this.period=d}return S(t,[{key:"generate",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},r=e.timestamp,n=void 0===r?Date.now():r;return t.generate({secret:this.secret,algorithm:this.algorithm,digits:this.digits,period:this.period,timestamp:n})}},{key:"validate",value:function(e){var r=e.token,n=e.timestamp,o=e.window;return t.validate({token:i.b.pad(r,this.digits),secret:this.secret,algorithm:this.algorithm,period:this.period,timestamp:n,window:o})}},{key:"toString",value:function(){
return U.stringify(this)}}],[{key:"generate",value:function(t){var e=t.secret,r=t.algorithm,n=t.digits,i=t.period,o=void 0===i?I.period:i,a=t.timestamp,s=void 0===a?Date.now():a;return T.generate({secret:e,algorithm:r,digits:n,counter:Math.floor(s/1e3/o)})}},{key:"validate",value:function(t){var e=t.token,r=t.secret,n=t.algorithm,i=t.period,o=void 0===i?I.period:i,a=t.timestamp,s=void 0===a?Date.now():a,h=t.window;return T.validate({token:e,secret:r,algorithm:n,counter:Math.floor(s/1e3/o),window:h})}}]),t}();r.d(e,"HOTP",function(){return T}),r.d(e,"TOTP",function(){return B}),r.d(e,"URI",function(){return U}),r.d(e,"Secret",function(){return g}),r.d(e,"Utils",function(){return i.b}),r.d(e,"version",function(){return"4.1.2"});e.default={HOTP:T,TOTP:B,URI:U,Secret:g,Utils:i.b,version:"4.1.2"}}])});
