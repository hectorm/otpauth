...
this._key[2*r+1]=o(Math.pow(i,1/3))<<24|this._keyr[r],r++)}},_block:function(t){var e,r,i,n,o=this._h,a=this._key,s=o[0],u=o[1],h=o[2],f=o[3],c=o[4],l=o[5],p=o[6],d=o[7],g=o[8],b=o[9],y=o[10],v=o[11],_=o[12],m=o[13],w=o[14],k=o[15];if("undefined"!=typeof Uint32Array){n=Array(160);for(var A=0;A<32;A++)n[A]=t[A]}else n=t;var U=s,B=u,S=h,T=f,I=c,O=l,x=p,P=d,C=g,R=b,M=y,j=v,L=_,z=m,E=w,H=k;for(e=0;e<80;e++){if(e<16)r=n[2*e],i=n[2*e+1];else{var D=n[2*(e-15)],V=n[2*(e-15)+1],q=(V<<31|D>>>1)^(V<<24|D>>>8)^D>>>7,N=(D<<31|V>>>1)^(D<<24|V>>>8)^(D<<25|V>>>7),$=n[2*(e-2)],G=n[2*(e-2)+1],Y=(G<<13|$>>>19)^($<<3|G>>>29)^$>>>6,Z=($<<13|G>>>19)^(G<<3|$>>>29)^($<<26|G>>>6),F=n[2*(e-7)],J=n[2*(e-7)+1],K=n[2*(e-16)],Q=n[2*(e-16)+1];r=q+F+((i=N+J)>>>0<N>>>0?1:0),r+=Y+((i+=Z)>>>0<Z>>>0?1:0),r+=K+((i+=Q)>>>0<Q>>>0?1:0)}n[2*e]=r|=0,n[2*e+1]=i|=0
...
f=c.prototype instanceof Uint8Array?function(t){return t.buffer}:function(t){for(var e=new Uint8Array(t.length),r=0;r<e.length;r++)e[r]=t[r];return e.buffer},a=function(t){var e=l.randomBytes(t);return f(e)},s=function(t,e,r){var i=l.createHmac(t,h(e));return i.update(h(r)),f(i.digest())}}else{var p,d=n.a.globalThis.crypto||n.a.globalThis.msCrypto;void 0!==d&&"function"==typeof d.getRandomValues?p=function(t){d.getRandomValues(t)}:(n.a.console.warn("Cryptography API not available, falling back to 'Math.random'..."),p=function(t){for(var e=0;e<t.length;e++)t[e]=Math.floor(256*Math.random())}),a=function(t){var e=new Uint8Array(t);return p(e),e.buffer},s=function(t,e,r){var i=u.hash[t.toLowerCase()];if(void 0===i)throw new TypeError("Unknown hash function");var n=new u.misc.hmac(u.codec.arrayBuffer.toBits(e),i);return n.update(u.codec.arrayBuffer.toBits(r)),u.codec.arrayBuffer.fromBits(n.digest(),!1)}}var g={randomBytes:a,hmacDigest:s};function b(t,e){for(var r=0;r<e.length;r++){var i=e[r]
