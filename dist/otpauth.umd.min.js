...
var e,r,i,n,o=this._h,s=this._key,a=o[0],l=o[1],h=o[2],f=o[3],u=o[4],c=o[5],d=o[6],p=o[7];for(e=0;e<64;e++)e<16?r=t[e]:(i=t[e+1&15],n=t[e+14&15],r=t[15&e]=(i>>>7^i>>>18^i>>>3^i<<25^i<<14)+(n>>>17^n>>>19^n>>>10^n<<15^n<<13)+t[15&e]+t[e+9&15]|0),r=r+p+(u>>>6^u>>>11^u>>>25^u<<26^u<<21^u<<7)+(d^u&(c^d))+s[e],p=d,d=c,c=u,u=f+r|0,f=h,h=l,a=r+((l=a)&h^f&(l^h))+(l>>>2^l>>>13^l>>>22^l<<30^l<<19^l<<10)|0;o[0]=o[0]+a|0,o[1]=o[1]+l|0,o[2]=o[2]+h|0,o[3]=o[3]+f|0,o[4]=o[4]+u|0,o[5]=o[5]+c|0,o[6]=o[6]+d|0,o[7]=o[7]+p|0}},sjcl.hash.sha512=function(t){this._key[0]||this._precompute(),t?(this._h=t._h.slice(0),this._buffer=t._buffer.slice(0),this._length=t._length):this.reset()},sjcl.hash.sha512.hash=function(t){return(new sjcl.hash.sha512).update(t).finalize()},sjcl.hash.sha512.prototype={blockSize:1024,reset:function(){return this._h=this._init.slice(0),this._buffer=[],this._length=0,this},update:function(t){"string"==typeof t&&(t=sjcl.codec.utf8String.toBits(t))
...
;var Q=C&P^~C&L,W=O&x^~O&M,tt=T&k^T&S^k&S,et=U&B^U&I^B&I,rt=(U<<4|T>>>28)^(T<<30|U>>>2)^(T<<25|U>>>7),it=(T<<4|U>>>28)^(U<<30|T>>>2)^(U<<25|T>>>7),nt=(O<<18|C>>>14)^(O<<14|C>>>18)^(C<<23|O>>>9),ot=(C<<18|O>>>14)^(C<<14|O>>>18)^(O<<23|C>>>9),st=s[2*e],at=s[2*e+1],lt=G+ot,ht=H+nt+(lt>>>0<G>>>0?1:0);ht+=Q+((lt+=W)>>>0<W>>>0?1:0),ht+=st+((lt+=at)>>>0<at>>>0?1:0);var ft=it+et;H=L,G=M,L=P,M=x,P=C,x=O,C=E+(ht+=r+((lt=lt+i|0)>>>0<i>>>0?1:0))+((O=R+lt|0)>>>0<R>>>0?1:0)|0,E=S,R=I,S=k,I=B,k=T,B=U,T=ht+(rt+tt+(ft>>>0<it>>>0?1:0))+((U=lt+ft|0)>>>0<lt>>>0?1:0)|0}l=o[1]=l+U|0,o[0]=a+T+(l>>>0<U>>>0?1:0)|0,f=o[3]=f+B|0,o[2]=h+k+(f>>>0<B>>>0?1:0)|0,c=o[5]=c+I|0,o[4]=u+S+(c>>>0<I>>>0?1:0)|0,p=o[7]=p+R|0,o[6]=d+E+(p>>>0<R>>>0?1:0)|0,y=o[9]=y+O|0,o[8]=g+C+(y>>>0<O>>>0?1:0)|0,v=o[11]=v+x|0,o[10]=b+P+(v>>>0<x>>>0?1:0)|0,_=o[13]=_+M|0,o[12]=m+L+(_>>>0<M>>>0?1:0)|0,A=o[15]=A+G|0,o[14]=w+H+(A>>>0<G>>>0?1:0)|0}},sjcl.misc.hmac=function(t,e){this._hash=e=e||sjcl.hash.sha256;var r,i=[[],[]],n=e.prototype.blockSize/32
