...
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports):"function"==typeof define&&define.amd?define(["exports"],e):e((t=t||self).OTPAuth={})}(this,(function(exports){"use strict";function _typeof(t){return(_typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _defineProperties(t,e){for(var r=0;r<e.length;r++){var i=e[r];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}function _createClass(t,e,r){return e&&_defineProperties(t.prototype,e),r&&_defineProperties(t,r),t}function _unsupportedIterableToArray(t,e){if(t){if("string"==typeof t)return _arrayLikeToArray(t,e);var r=Object.prototype.toString.call(t).slice(8,-1)
;return"Object"===r&&t.constructor&&(r=t.constructor.name),"Map"===r||"Set"===r?Array.from(t):"Arguments"===r||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r)?_arrayLikeToArray(t,e):void 0}}function _arrayLikeToArray(t,e){(null==e||e>t.length)&&(e=t.length);for(var r=0,i=new Array(e);r<e;r++)i[r]=t[r];return i}function _createForOfIteratorHelper(t,e){var r;if("undefined"==typeof Symbol||null==t[Symbol.iterator]){if(Array.isArray(t)||(r=_unsupportedIterableToArray(t))||e&&t&&"number"==typeof t.length){r&&(t=r);var i=0,n=function(){};return{s:n,n:function(){return i>=t.length?{done:!0}:{done:!1,value:t[i++]}},e:function(t){throw t},f:n}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var o,s=!0,a=!1;return{s:function(){r=t[Symbol.iterator]()},n:function(){var t=r.next();return s=t.done,t},e:function(t){a=!0,o=t},f:function(){try{s||null==r.return||r.return()}finally{if(a)throw o}}}}var Utils={uint:{
fromBuf:function(t){for(var e=new Uint8Array(t),r=0,i=0;i<e.length;i++)0!==e[i]&&(r*=256,r+=e[i]);return r},toBuf:function(t){for(var e=new ArrayBuffer(8),r=new Uint8Array(e),i=t,n=7;n>=0&&0!==i;n--)r[n]=255&i,i-=r[n],i/=256;return e}},raw:{fromBuf:function(t){for(var e=new Uint8Array(t),r="",i=0;i<e.length;i++)r+=String.fromCharCode(e[i]);return r},toBuf:function(t){for(var e=new ArrayBuffer(t.length),r=new Uint8Array(e),i=0;i<t.length;i++)r[i]=t.charCodeAt(i);return e}},b32:{alphabet:"ABCDEFGHIJKLMNOPQRSTUVWXYZ234567",fromBuf:function(t){for(var e=new Uint8Array(t),r=0,i=0,n="",o=0;o<e.length;o++)for(i=i<<8|e[o],r+=8;r>=5;)n+=Utils.b32.alphabet[i>>>r-5&31],r-=5;return r>0&&(n+=Utils.b32.alphabet[i<<5-r&31]),n},toBuf:function(t){t=t.toUpperCase().replace(/=+$/,"");for(var e=new ArrayBuffer(5*t.length/8|0),r=new Uint8Array(e),i=0,n=0,o=0,s=0;s<t.length;s++){var a=Utils.b32.alphabet.indexOf(t[s]);if(-1===a)throw new TypeError("Invalid character found: ".concat(t[s]));n=n<<5|a,(i+=5)>=8&&(r[o++]=n>>>i-8&255,
i-=8)}return e}},hex:{fromBuf:function(t){for(var e=new Uint8Array(t),r="",i=0;i<e.length;i++){var n=e[i].toString(16);r+=2===n.length?n:"0".concat(n)}return r.toUpperCase()},toBuf:function(t){for(var e=new ArrayBuffer(t.length/2),r=new Uint8Array(e),i=0,n=0;i<r.length;i+=1,n+=2)r[i]=parseInt(t.substr(n,2),16);return e}},pad:function(t,e){for(var r="",i=e-String(t).length;i-- >0;)r+="0";return"".concat(r).concat(t)}},InternalUtils={get globalThis(){var t;if("object"===("undefined"==typeof globalThis?"undefined":_typeof(globalThis)))t=globalThis;else{Object.defineProperty(Object.prototype,"__magicalGlobalThis__",{get:function(){return this},configurable:!0});try{t=__magicalGlobalThis__}finally{delete Object.prototype.__magicalGlobalThis__}}return void 0===t&&("undefined"!=typeof self?t=self:"undefined"!=typeof window?t=window:"undefined"!=typeof global&&(t=global)),Object.defineProperty(this,"globalThis",{enumerable:!0,value:t}),this.globalThis},get console(){
...
this._key[2*r+1]=o(Math.pow(i,1/3))<<24|this._keyr[r],r++)}},_block:function(t){var e,r,i,n,o=this._h,s=this._key,a=o[0],l=o[1],h=o[2],f=o[3],u=o[4],c=o[5],d=o[6],p=o[7],g=o[8],y=o[9],b=o[10],v=o[11],m=o[12],_=o[13],w=o[14],A=o[15];if("undefined"!=typeof Uint32Array){n=Array(160);for(var j=0;j<32;j++)n[j]=t[j]}else n=t;var U=a,T=l,k=h,B=f,S=u,I=c,E=d,R=p,C=g,O=y,P=b,x=v,L=m,M=_,H=w,G=A;for(e=0;e<80;e++){if(e<16)r=n[2*e],i=n[2*e+1];else{var z=n[2*(e-15)],N=n[2*(e-15)+1],D=(N<<31|z>>>1)^(N<<24|z>>>8)^z>>>7,V=(z<<31|N>>>1)^(z<<24|N>>>8)^(z<<25|N>>>7),X=n[2*(e-2)],q=n[2*(e-2)+1],F=(q<<13|X>>>19)^(X<<3|q>>>29)^X>>>6,$=(X<<13|q>>>19)^(q<<3|X>>>29)^(X<<26|q>>>6),Y=n[2*(e-7)],Z=n[2*(e-7)+1],J=n[2*(e-16)],K=n[2*(e-16)+1];r=D+Y+((i=V+Z)>>>0<V>>>0?1:0),r+=F+((i+=$)>>>0<$>>>0?1:0),r+=J+((i+=K)>>>0<K>>>0?1:0)}n[2*e]=r|=0,n[2*e+1]=i|=0
;var Q=C&P^~C&L,W=O&x^~O&M,tt=U&k^U&S^k&S,et=T&B^T&I^B&I,rt=(T<<4|U>>>28)^(U<<30|T>>>2)^(U<<25|T>>>7),it=(U<<4|T>>>28)^(T<<30|U>>>2)^(T<<25|U>>>7),nt=(O<<18|C>>>14)^(O<<14|C>>>18)^(C<<23|O>>>9),ot=(C<<18|O>>>14)^(C<<14|O>>>18)^(O<<23|C>>>9),st=s[2*e],at=s[2*e+1],lt=G+ot,ht=H+nt+(lt>>>0<G>>>0?1:0);ht+=Q+((lt+=W)>>>0<W>>>0?1:0),ht+=st+((lt+=at)>>>0<at>>>0?1:0);var ft=it+et;H=L,G=M,L=P,M=x,P=C,x=O,C=E+(ht+=r+((lt=lt+i|0)>>>0<i>>>0?1:0))+((O=R+lt|0)>>>0<R>>>0?1:0)|0,E=S,R=I,S=k,I=B,k=U,B=T,U=ht+(rt+tt+(ft>>>0<it>>>0?1:0))+((T=lt+ft|0)>>>0<lt>>>0?1:0)|0}l=o[1]=l+T|0,o[0]=a+U+(l>>>0<T>>>0?1:0)|0,f=o[3]=f+B|0,o[2]=h+k+(f>>>0<B>>>0?1:0)|0,c=o[5]=c+I|0,o[4]=u+S+(c>>>0<I>>>0?1:0)|0,p=o[7]=p+R|0,o[6]=d+E+(p>>>0<R>>>0?1:0)|0,y=o[9]=y+O|0,o[8]=g+C+(y>>>0<O>>>0?1:0)|0,v=o[11]=v+x|0,o[10]=b+P+(v>>>0<x>>>0?1:0)|0,_=o[13]=_+M|0,o[12]=m+L+(_>>>0<M>>>0?1:0)|0,A=o[15]=A+G|0,o[14]=w+H+(A>>>0<G>>>0?1:0)|0}},sjcl.misc.hmac=function(t,e){this._hash=e=e||sjcl.hash.sha256;var r,i=[[],[]],n=e.prototype.blockSize/32
