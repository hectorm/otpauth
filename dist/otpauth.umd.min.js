...
var e,r,i,n,o=this._h,s=this._key,a=o[0],l=o[1],h=o[2],u=o[3],c=o[4],f=o[5],d=o[6],p=o[7];for(e=0;e<64;e++)e<16?r=t[e]:(i=t[e+1&15],n=t[e+14&15],r=t[15&e]=(i>>>7^i>>>18^i>>>3^i<<25^i<<14)+(n>>>17^n>>>19^n>>>10^n<<15^n<<13)+t[15&e]+t[e+9&15]|0),r=r+p+(c>>>6^c>>>11^c>>>25^c<<26^c<<21^c<<7)+(d^c&(f^d))+s[e],p=d,d=f,f=c,c=u+r|0,u=h,h=l,a=r+((l=a)&h^u&(l^h))+(l>>>2^l>>>13^l>>>22^l<<30^l<<19^l<<10)|0;o[0]=o[0]+a|0,o[1]=o[1]+l|0,o[2]=o[2]+h|0,o[3]=o[3]+u|0,o[4]=o[4]+c|0,o[5]=o[5]+f|0,o[6]=o[6]+d|0,o[7]=o[7]+p|0}},sjcl.hash.sha512=function(t){this._key[0]||this._precompute(),t?(this._h=t._h.slice(0),this._buffer=t._buffer.slice(0),this._length=t._length):this.reset()},sjcl.hash.sha512.hash=function(t){return(new sjcl.hash.sha512).update(t).finalize()},sjcl.hash.sha512.prototype={blockSize:1024,reset:function(){return this._h=this._init.slice(0),this._buffer=[],this._length=0,this},update:function(t){"string"==typeof t&&(t=sjcl.codec.utf8String.toBits(t))
